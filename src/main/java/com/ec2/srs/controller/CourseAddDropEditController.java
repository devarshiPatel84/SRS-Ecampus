...
@Controller
public class CourseAddDropEditController {
    ...
    public String editCourses(
        ...
        if(semesterId.shortValue() != maxStrid.shortValue() || !isWithinDeadline) {
            ...
            return RegistrationConstants.JSPCOURSEADDDROPVIEW;
        }
        else{
            ...
            return RegistrationConstants.JSPCOURSEADDDROPEDIT;
        }
